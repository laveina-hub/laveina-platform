...
export async function createShipment(
  ...
  // Admin client bypasses RLS — only called from Stripe webhook after payment
  // tracking_id auto-generated by DB trigger; qr_code_url set after QR generation
...
/** Public tracking lookup. Bypasses RLS (unauthenticated). Returns only non-sensitive fields. */
